...
export default function InsightsPage() {
  ...
  return (
    <main className="relative min-h-screen bg-white text-black overflow-x-hidden">
          ...
          <div className="bg-white/70 backdrop-blur-md rounded-lg shadow-md p-6 w-full">
            ...
            <div className="w-full mt-6">
              ...
              <p className="text-sm text-gray-700">
                Built with Python using Pandas and Scikit-learn. It parses user logs (sleep, hydration, mood)
                in JSON/CSV format and generates human-friendly health advice.
                <br /><br />
                ...
                powered by the Insight Engine logic.
                <br /><br />
                📊 Visual Dashboard — Trend charts for sleep/hydration/mood. Optional GPT-style chat via LangChain.
                <br /><br />
                🛠️ Stack: Python, Pandas, NLTK, Scikit-learn, Streamlit, Plotly, LangChain
                <br /><br />
                📦 Deliverables: GitHub repo with code, sample data, optional Loom walkthrough.
              </p>
            </div>
      ...
      {/* ✅ Mobile-Friendly Collapsible Chatbot */}
